...
import 'package:enable_hire_user/features/profile/view/edit_resume_screen.dart';
...
class ApplicantDetailsScreen extends ConsumerStatefulWidget {
  ...
  const ApplicantDetailsScreen({Key? key, required this.resumeId}) : super(key: key);
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(onPressed: (){
        Navigator.push(context, MaterialPageRoute(builder: (context){
          return EditResumeScreen();
        }));
      },child: Icon(Icons.edit,color: Colors.white,),backgroundColor: Styles.primary,),
      appBar:  AppBar(
                  ...
                  children: [
                    ClipOval(
                      child: CachedNetworkImage(
                        imageUrl: resumeData['profilePic'],
